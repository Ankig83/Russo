...
export const sections = [
  ...
  { id: 'drawer_1',   type: 'drawer', label: 'Эксклюзивные изделия', route: '/exclusive' },
  { id: 'drawer_2',   type: 'drawer', label: 'Портфолио',            route: '/portfolio' },
  { id: 'drawer_3',   type: 'drawer', label: 'Каталог',              route: '/catalog'   },
  { id: 'drawer_4',   type: 'drawer', label: 'О нас',                route: '/about'     },
  { id: 'drawer_5',   type: 'drawer', label: 'Контакты',             route: '/contacts'  },
]
